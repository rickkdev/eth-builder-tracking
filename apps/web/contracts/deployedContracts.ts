  ...
  1: {
    CodesRegistry: {
      ...
      abi: [
        ...
        { type: "error", name: "CodeAlreadyExists", inputs: [] },
        { type: "error", name: "CodeEmpty", inputs: [] },
        { type: "error", name: "CodeInvalidChar", inputs: [] },
        { type: "error", name: "CodeNotFound", inputs: [] },
        { type: "error", name: "CodeTooLong", inputs: [] },
        {
          type: "error",
